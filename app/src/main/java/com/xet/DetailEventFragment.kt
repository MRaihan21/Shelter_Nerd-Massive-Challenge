...
//            }
    ...
    private fun movePayment(){
        val action = DetailEventFragmentDirections.actionDetailEventFragment2ToPaymentFragment()
        findNavController().navigate(action)
    }

    private fun moveLocation(){
        val action = DetailEventFragmentDirections.actionDetailEventFragment2ToLocationFragment()
        findNavController().navigate(action)
    }

    private fun moveCreator(){
        val action = DetailEventFragmentDirections.actionDetailEventFragment2ToCreatorFragment()
        findNavController().navigate(action)
    }
